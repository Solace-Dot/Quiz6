...
export const serviceDetailsReducer = (state = { service: null }, action) => {
  switch (action.type) {
    ...
    case SERVICE_DETAILS_FAIL:
      return { loading: false, service: null, error: action.payload };
    default:
      return state;
  }
};

export const sellerServiceListReducer = (state = { services: [] }, action) => {
  switch (action.type) {
    case SELLER_SERVICE_LIST_REQUEST:
      return { ...state, loading: true };
    case SELLER_SERVICE_LIST_SUCCESS:
      return { loading: false, services: action.payload };
    case SELLER_SERVICE_LIST_FAIL:
      return { loading: false, services: [], error: action.payload };
    default:
      return state;
  }
